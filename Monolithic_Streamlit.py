...
def main():
    ...
    with col1:
        ...
        cgpa = st.number_input("CGPA", min_value=0.0, max_value=10.0, value=0)
        tenth_percentage = st.number_input("10th Percentage", min_value=0.0, max_value=100.0, value=0)
        twelfth_percentage = st.number_input("12th Percentage", min_value=0.0, max_value=100.0, value=0)
        attendance_percentage = st.number_input("Attendance Percentage", min_value=0.0, max_value=0, value=0)
        study_hours = st.number_input("Study Hours per Day", min_value=0.0, max_value=24.0, value=0)
    ...
    with col3:
        sleep_hours = st.number_input("Sleep Hours per Day", min_value=0.0, max_value=24.0, value=0)
