...
def main():
    ...
    with col1:
        ...
        tenth_percentage = st.number_input("10th Percentage", min_value=0.0, max_value=100.0, value=75.0)
        twelfth_percentage = st.number_input("12th Percentage", min_value=0.0, max_value=100.0, value=75.0)
    ...
    with col2:
        ...
        internships = st.number_input("Internships Completed", min_value=0, max_value=20, value=1)
        hackathons = st.number_input("Hackathons Participated", min_value=0, max_value=50, value=0)
        certifications = st.number_input("Certifications Count", min_value=0, max_value=50, value=1)
